...
<script>
	...
	$(document).ready(function() {
		...
		*/		
		...
		URL	
		- Required. 
		- Specifies the URL you wish to load
		data	
		- Optional. 
		- Specifies data to send to the server along with the request
		function(response,status,xhr)	
		- Optional. 
		- Specifies a callback function to run when the load() method is completed.
